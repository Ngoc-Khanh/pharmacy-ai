from typing import Optional, Union, List, TypeVar, Dict, Any
from app.models import APIResponse, SuccessResponse, ErrorResponse
...
def create_unauthorized_response(
    ...
    Returns:
        Dict với định dạng API response 401
    """
    return {
        "data": None,
        "message": message,
        "status": 401,
        "locale": locale,
        "errors": "Yêu cầu xác thực để truy cập tài nguyên này"
    } 